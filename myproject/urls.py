...
from view_item import views as view_item_views
...
urlpatterns = [
    ...
    re_path(r'^choose_item$', view_item_views.choose_item, name='choose_item'),
    re_path(r'^view_item$', view_item_views.view_item, name='view_item'),
]
