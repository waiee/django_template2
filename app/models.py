...
class Item(models.Model):
    ...
    item_price = models.FloatField(default=None, max_digits=8)
...
class Product(models.Model):
    ...
    product_price = models.FloatField(default=None, max_digits=8)
...
class Quotation(models.Model):
    ...
    product_name = models.CharField(max_length=40)
    product_price = models.FloatField(default=None, max_digits=8)
    total_price = models.FloatField(default=None, max_digits=8)
